...
<head>
  ...
  <title>DangKhoa_Dev • Tool Store + Admin (Demo VIP)</title>
  ...
  <header class="navbar">
    <div class="nav-inner">
      ...
      <div class="brand">
          ...
          <div class="brand-text">DangKhoa_Dev</div>
      </div>
          ...
          <div class="banner-vip-container">
            ...
            <div class="banner-vip-overlay">
                <div class="banner-content-left">
                    ...
                    <h3 class="banner-main-title">Dang Khoa Developer</h3>
                    <p class="banner-subtitle">Tool & Utilities</p>
...
<div class="modal" id="adminEditUserModal" aria-hidden="true" role="dialog" aria-modal="true" aria-labelledby="adminEditUserModalTitle">
  ...
  <script>
    ...
    const TOOLS = [
      { id:'t1', name:'Tool Spam SMS', desc:'Spam OPT Qua Sim', price:150000, 
      ...
      { id:'t2', name:'Tool Spam Ngl', desc:'Spam Tin Nhắn Ngl', price:150000, 
